 ...
 * @author csiqueira
 */
public class PowerStageSetEvent extends MatchEvent {
    ...
    public PowerStageSetEvent(GameMechanic gameMechanic, MatchPersonality personality, MatchPlayer player, Integer powerStageGain) {
    ...
    public String logMessage() {
        return "POWER STAGE SET";
    }

    @Override
    protected void phaseEffect(Match m) {
        MatchPersonalityDLO.setPowerStage(this.personality, this.powerStageChange);
    }
